...
#else
static const char *fonts[]               = { "terminus:size=13", "Iosevka Nerd Font:size=15", };
...
/*
#define NUMCOLORS 12
static const char colors[NUMCOLORS][ClkLast][9] = {
